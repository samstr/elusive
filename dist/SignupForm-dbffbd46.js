...
var ElusiveClient = require('./ElusiveClient-e7f8ebd1.js');
...
var signupForm = require('./signupForm-d7904e62.js');
...
var stylesheet = asyncToGenerator.createCommonjsModule(function (module, exports) {
...
asyncToGenerator.unwrapExports(stylesheet);

var stylesheetRegistry = asyncToGenerator.createCommonjsModule(function (module, exports) {
...
asyncToGenerator.unwrapExports(stylesheetRegistry);

var style = asyncToGenerator.createCommonjsModule(function (module, exports) {
...
asyncToGenerator.unwrapExports(style);
...
function exactProp(propTypes) {
  ...
  return _extends({}, propTypes, defineProperty$1._defineProperty({}, specialProperty, function (props) {
...
function createMixins(breakpoints, spacing, mixins) {
  ...
  return _extends({
    gutters: function gutters() {
      ...
      }, styles), {}, defineProperty$1._defineProperty({}, breakpoints.up('sm'), _extends({
    ...
    toolbar: (_toolbar = {
      minHeight: 56
    }, defineProperty$1._defineProperty(_toolbar, "".concat(breakpoints.up('xs'), " and (orientation: landscape)"), {
      minHeight: 48
    }), defineProperty$1._defineProperty(_toolbar, breakpoints.up('sm'), {
      minHeight: 64
    }), _toolbar)
  }, mixins);
}
        ...
        if (depth === 1) {
          ...
          if (process.env.NODE_ENV !== 'production') {
            console.error(["Material-UI: The `".concat(parentKey, "` component increases ") + "the CSS specificity of the `".concat(key, "` internal state."), 'You can not override it like this: ', JSON.stringify(node, null, 2), '', 'Instead, you need to use the $ruleName syntax:', JSON.stringify({
              root: defineProperty$1._defineProperty({}, "&$".concat(key), child)
...
var MuiLink = withStyles$1(styles$1, {
  name: 'MuiLink'
})(Link);
...
NextComposed.propTypes = {
  as: PropTypes__default.oneOfType([PropTypes__default.string, PropTypes__default.object]),
  href: PropTypes__default.oneOfType([PropTypes__default.string, PropTypes__default.object]),
  prefetch: PropTypes__default.bool
...
var LoginWithLinkForm = function LoginWithLinkForm(_ref) {
  ...
  var onChange = function onChange(event) {
    ...
    setValues(_objectSpread(_objectSpread({}, values), {}, defineProperty$1._defineProperty({}, field, value)));
  };
